...
void loop(){
 WiFiClient client;   // listen for incoming clients
  ...
  if (server.available()) {                             // if you get a client,
      ...
      if (client.available()) {             // if there's bytes to read from the client,
        ...
        if (c == '\n') {                    // if the byte is a newline character
          ...
          if (currentLine.length() == 0) {
            ...
            client.print("Click <a href=\"/O\">here</a> to turn on .<br>");
            client.print("Click <a href=\"/F\">here</a> to turn off.<br>");
            client.print("Click <a href=\"/R\">here</a> to restart.<br>");
